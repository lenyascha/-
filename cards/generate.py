...
CARDS = [
    ...
    {
        "id": "card-7",
        "positions": ["Консультант", "Заместитель начальника отдела"],
        "department": "Отдел мониторинга деятельности арбитражных управляющих",
        "icons": [
            ("alert-triangle", "Анализ деятельности АУ и выявление нарушений законодательства"),
            ("database", "Контроль ведения реестра АУ"),
            ("checklist", "Контроль деятельности АУ и формирование реестра"),
            ("scale", "Анализ судебной практики, предложения по НПА"),
            ("shield", "Контроль споров по субсидиарной ответственности и оспариванию сделок"),
            ("book", "Знание НК, ГК, АПК, ГПК, УПК и Закона о банкротстве"),
            ("chip", "Участие в пилотных проектах"),
        ],
    },
]
